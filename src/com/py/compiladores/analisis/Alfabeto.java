...
public class Alfabeto implements Iterable<String> {
     ...
     * @return El simbolo del alfabeto ubicado en la posicion pos.
     */
     ...
     * @return true si el caracter pertenece al alfabeto, false en caso contrario.
     */
     ...
     * de un caracter en este Alfabeto.
