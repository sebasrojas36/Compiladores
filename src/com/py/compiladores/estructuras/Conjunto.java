...
public class Conjunto<T extends Comparable<T>>
     ...
     * de un elemento en este Conjunto.
    ...
    /**
     * Determina si este Conjunto esta vacio
     * @return true si este Conjunto
     * esta vacio, false en caso contrario.
     */
     ...
     * o transiciones.
     * @return Un objeto Iterator con los
    ...
    /**
     * Comprueba si un elemento esta contenido en este Conjunto.
     * @param elemento Objeto a buscar en el Conjunto.
     * @return true si elemento esta en el
     * Conjunto, false en caso contrario.
     */
     ...
     * @param subconjunto Conjunto de elementos que deben
     * ser retenidos en este Conjunto (los demas seran
     * eliminados).
     * @return true si este Conjunto ha
     * cambiado como consecuencia de esta llamada, false
     * en caso contrario.
     */
     ...
     * @return true si el conjunto esta
